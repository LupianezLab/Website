...
<details>
  <summary>
    <img src="../images/umap5.png" style="width: 30px; height: 20px; vertical-align: middle; margin-right: 8px; border-radius: 3px; position: relative; top: 2px;" />
...
<details>
  <summary>
      <img src="../images/chipseq.png" style="width: 30px; height: 20px; vertical-align: middle; margin-right: 8px; border-radius: 3px; position: relative; top: 2px;" />           <strong>Identification of regulatory elements (ChIP-seq, ATAC-seq)</strong>
  </summary>
